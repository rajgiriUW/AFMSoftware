...
//raj - 90 degrees; for 0 degrees change 2, 3, 0, 1 to 0, 1, 2, 3 in next 4 lines
...
// raj -- for single points, change the second [x] to whatever line you want, e.g. [p][25][0], the 25 is the relevant one
		Xdownwave[] = XYupdownwave[p][10][0]
		Xupwave[] = XYupdownwave[p][10][1]
		Ydownwave[] = XYupdownwave[p][10][2]
		Yupwave[] = XYupdownwave[p][10][3]
