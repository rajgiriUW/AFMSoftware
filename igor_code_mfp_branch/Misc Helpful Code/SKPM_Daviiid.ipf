...
Function ImageScanSKPM(xpos, ypos, liftheight, scansizeX,scansizeY, scanlines, scanpoints, scanspeed)
	...
	variable v0=0
	variable vend=4
	variable deltav = (vend-v0)/scanlines
	variable appliedVoltage = v0
	...
	do
		...
		appliedVoltage = v0+i*deltav
		print "Applied bias: ", appliedVoltage, " V"
		
		td_wv("Output.C", appliedVoltage)
