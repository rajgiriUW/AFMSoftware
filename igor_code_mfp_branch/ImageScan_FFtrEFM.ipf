...
//		endif
	...
	do
		...
		SetFeedbackLoop(3, "always",  "ZSensor", heightbefore/GV("ZLVDTSens")-100*1e-9/GV("ZLVDTSens"),0,EFMFilters[%ZHeight][%IGain],0, "Output.Z",0, name="OutputZ") // note the integral gain of 10000
		sleep/S 1
